...
enum WidgetPublisher {
    static func publish(tasks: [TenoraTask], events: [CalendarEvent], calendarKnown: Bool, focusedTaskID: UUID?) {
        ...
        let snapshot = WidgetSnapshot(updatedAt: Date(), tasks: tasks, events: events, calendarKnown: calendarKnown, startHour: hours.startHour, endHour: hours.endHour, focusedTaskID: focusedTaskID, schedule: AttentionPreferences.schedule)
